...
<div id="wrapper" class="hfeed site">
	...
	<?php if ( is_front_page() ) {
		 if ( is_active_sidebar( 'bannerhdr' ) ) : ?>
			<div id="bannerhdr" class="bannerhdr widget-area" role="complementary">
				<?php dynamic_sidebar( 'bannerhdr' ); ?>
			</div><!-- #bannerhdr -->
	<?php endif;
	}
	 ?>
	...
	<div id="bannercontainer">
		<div class="banner row">
			...
			<div id="msp-entry-title-cntr">
			<div id="msp-entry-title">
				<h1 class="entry-title2" style="color:white;"><?php the_title(); ?></h1>
			</div><!-- #msp-entry-title -->
				<div id="ggl-trans">
