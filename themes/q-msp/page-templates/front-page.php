...
get_header('home'); ?>
	...
	<section id="mezzo-top-container">

			<div class="col grid_12_of_12">
				<div id="mezzo-top" class="mezzo">
					<?php dynamic_sidebar( 'mezzo-top' ); ?>
				</div>  <!-- /#mezzo-top -->
			</div> <!-- /.col.grid_12_of_12 -->

	</section> <!--/#mezzo-top-container -->
		
	<section id="mezzo-btm-container">

			<div class="col grid_12_of_12">
				<div id="mezzo-btm" class="mezzo">
					<?php dynamic_sidebar( 'mezzo-btm' ); ?>
				</div>  <!-- /#mezzo-btm -->
			</div> <!-- /.col.grid_12_of_12 -->

	</section> <!--/#mezzo-btm-container -->
